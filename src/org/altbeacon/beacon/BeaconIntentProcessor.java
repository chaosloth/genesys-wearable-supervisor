...
public class BeaconIntentProcessor extends IntentService {
	...
	public void onStart(Intent intent, int startId) {
		...
		BeaconManager.logDebug(TAG, "**CJC: Starting intent BeaconIntentProcessor.onStart() ");
	}
	...
	protected void onHandleIntent(Intent intent) {
		BeaconManager.logDebug(TAG, "**CJC got an intent to process");
		...
		if (rangingData != null) {
			...
			if (notifier != null) {
				BeaconManager.logDebug(TAG, "**CJC: calling didRangeBeaconsInRegion");
